...
public class EmployeeController {
	...
	public ResponseEntity<Void> deleteEmployeeById(@PathVariable("empid") Long empidL) throws Exception{
	...
	public ResponseEntity<?> updateEmployee(@RequestBody Employee employee){
		try {
		Employee employeeSaved = employeeServiceInterface.updateEmployee(employee);
	...
	public ResponseEntity<?> partialUpdate(@RequestBody Employee employee, @PathVariable("empid") Long empidL) throws Exception{
		Employee partialUpdated = employeeServiceInterface.partialUpdate(empidL, employee);
		return new ResponseEntity<Employee>(partialUpdated, HttpStatus.OK);
	}
}
